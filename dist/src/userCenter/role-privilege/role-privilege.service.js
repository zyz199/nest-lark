...
exports.RolePrivilegeService = void 0;
const common_1 = require("@nestjs/common");
const typeorm_1 = require("typeorm");
let RolePrivilegeService = class RolePrivilegeService {
    constructor(rolePrivilegeRepository) {
    ...
    set(roleId, privilegeIds, systemId) {
        const rolePrivileges = privilegeIds.map((privilegeId) => {
            return {
                systemId,
                roleId,
                privilegeId,
...
RolePrivilegeService = __decorate([
    (0, common_1.Injectable)(),
    __param(0, (0, common_1.Inject)("ROLE_PRIVILEGE_REPOSITORY")),
    __metadata("design:paramtypes", [typeorm_1.Repository])
], RolePrivilegeService);
exports.RolePrivilegeService = RolePrivilegeService;
//# sourceMappingURL=role-privilege.service.js.map